-- FAQ de dúvidas: perguntas com múltiplas respostas (uma por gestora), dúvidas pendentes, frequência
-- Embeddings ficam no Evo; esta tabela é preenchida pelo Evo para busca por similaridade
...
-- Uma resposta por gestora por pergunta (editável)
...
-- Dúvidas dos leads sem match; quando uma gestora responde, vira FAQ e envia ao lead
...
-- Vetores gerados pelo Evo (OpenAI); Evo lê/escreve para busca por similaridade
